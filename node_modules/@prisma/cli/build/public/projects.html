    ...
    <div class="content">
      <div class="projects">
        <div class="project">
          ...
          <a
            href="./preview?project=capabilities"
            class="title link "
            >Capabilities Demo</a
          >
        ...
        <div class="project">
          ...
          <a
            class="url"
            href="https://github.com/prisma/prisma-datasets/tree/master/datasets/sqlite/climate"
            target="_blank"
            rel="noreferrer noopener"
          >
            <svg fill="black" viewBox="0 0 40 40">
              <g>
                <path
        ...
        <div class="project">
          ...
          <a
            href="./preview?project=northwind"
            class="title link "
            >Northwind</a
          >
          ...
          <a
            class="url"
            href="https://github.com/prisma/prisma-datasets/tree/master/datasets/sqlite/northwind"
            target="_blank"
            rel="noreferrer noopener"
          >
            <svg fill="black" viewBox="0 0 40 40">
        ...
        <div class="project">
          ...
          <a
            class="url"
            href="https://github.com/prisma/prisma-datasets/tree/master/datasets/sqlite/imdb"
            target="_blank"
            rel="noreferrer noopener"
          >
            <svg fill="black" viewBox="0 0 40 40">
        ...
        <div class="project">
          ...
          <a
            href="./preview?project=chinook"
            class="title link deprecated"
            >Chinook</a
          >
          ...
          <a
            class="url"
            href="https://github.com/prisma/prisma-datasets/tree/master/datasets/sqlite/chinook"
            target="_blank"
            rel="noreferrer noopener"
          >
            <svg fill="black" viewBox="0 0 40 40">
      ...
      <div class="disclaimer">
        The above are demo deployments for Prisma Studio. Note that the underlying database itself is read-only. <br />You will be able to make changes in
        Studio, but you will not be able to persist them.
      </div>
    </div>
  </body>
